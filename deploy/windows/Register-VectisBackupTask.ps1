...
.EXAMPLE
  .\deploy\windows\Register-VectisBackupTask.ps1 -DataDir "E:\vectis\vectis-data-r2"
#>
param(
  [string]$DataDir = (Join-Path (Split-Path -Parent (Split-Path -Parent $PSScriptRoot)) "vectis-data-r2"),
