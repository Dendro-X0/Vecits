...
import { slugifyHelpSectionId } from "@/lib/help/section-id";

export default function HelpIndexPage() {
  const contentGroups = HELP_NAV_GROUPS.filter((group) => group.id !== "start");
  const toc = contentGroups.map((group) => ({
    id: slugifyHelpSectionId(group.label),
    label: group.label
  }));
