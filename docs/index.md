...
- Broader in-place term rewrite beyond OrderAmend v1 (`evidenceFormat`, add/remove milestones)
...
```bash
cargo run --bin cli -- fixtures run    # 27 valid, 38 invalid — all should pass
