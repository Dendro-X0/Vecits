...
Documentation for the official Vectis web/desktop client (`apps/web`) and how it relates to in-app user help.
...
User-facing copy lives in the client at `/help`. Protocol and operator truth stays in `/docs` outside the app.
