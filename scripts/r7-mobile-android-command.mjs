...
function usage() {
  console.log(`Usage:
  node ./scripts/r7-mobile-android-command.mjs <dev|build> [options] [-- <extra tauri args>]
...
function main() {
  ...
  const tauriArgs = ["--filter", "@vectis/desktop", "exec", "tauri", "android", parsed.command];
  ...
  if (parsed.dryRun) {
    console.log("R7-M2 mobile command dry-run");
